  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-6 grid grid-cols-2 gap-3">
        <button
          type="button"
          className="flex items-center justify-center gap-2 px-4 py-2.5 border border-[var(--neutral-200)] rounded-lg bg-white hover:bg-[var(--neutral-50)] transition-colors text-sm font-medium text-[var(--neutral-700)]"
        >
